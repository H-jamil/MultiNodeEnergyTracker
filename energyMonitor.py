    ...
    def print_results(self):
        while not self.stop_event.is_set():
            ...
            if measurements:
                ...
                print(f"GPU Energy:         {gpu_total:.2f} J")
